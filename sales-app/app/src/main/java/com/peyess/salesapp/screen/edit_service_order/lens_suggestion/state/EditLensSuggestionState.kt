...
import com.peyess.salesapp.data.repository.edit_service_order.lens_comparison.EditLensComparisonDeleteResponse
...
typealias TableLensesResponse = Either<LocalLensRepositoryException, Flow<PagingData<LensPickModel>>>

typealias LensesTypesResponse = Either<LocalLensRepositoryException, List<LensFilterTypeImpl>>

typealias LensesSuppliersResponse = Either<LocalLensRepositoryException, List<LensFilterSupplierImpl>>

typealias LensesFamiliesResponse = Either<LocalLensRepositoryException, List<LensFilterFamilyImpl>>

typealias LensesDescriptionsResponse = Either<LocalLensRepositoryException, List<LensFilterDescriptionImpl>>

typealias LensesMaterialsResponse = Either<LocalLensRepositoryException, List<LensFilterMaterialImpl>>

typealias LensesSpecialtiesResponse = Either<LocalLensRepositoryException, List<LensFilterSpecialtyImpl>>

typealias LensesGroupsResponse = Either<LocalLensRepositoryException, List<LensFilterGroupImpl>>

typealias LensesGroupsCompleteResponse = Either<LocalLensRepositoryException, List<StoreLensGroupDocument>>
